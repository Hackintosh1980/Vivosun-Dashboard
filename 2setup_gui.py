...
try:
    ...
    from main_gui import core_gui, theme_picker
...
# ============ GLOBAL STYLE (für ttk Widgets) ============
    style = ttk.Style()
    style.theme_use("default")
    icon_loader.set_app_icon(root)

    # ============ THEME SWITCHER (aus main_gui/theme_picker) ============
    ...
    def on_theme_change(new_name):
        """Wird aufgerufen, wenn im Picker ein neues Theme gewählt wurde."""
